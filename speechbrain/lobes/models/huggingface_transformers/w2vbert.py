...
class Wav2VecBert(HFTransformersInterface):
    ...
    **kwargs
    ...
    >>> save_path = "savedir"
    >>> model = Wav2VecBert(model_hub, save_path)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # self.normalize_wav = self.feature_extractor.do_normalize Seamless does not have this

        self.freeze_feature_extractor = freeze_feature_extractor
        if not self.freeze and self.freeze_feature_extractor:
            logger.warning(
                "speechbrain.lobes.models.huggingface_transformers.w2vbert - Wav2VecBert feature extractor is frozen."
            )
    ...
    def extract_features(self, wav, wav_lens=None):
        ...
        # wav_norm = F.layer_norm(wav, wav.shape[1:])
        ...
        print("the device1 = ", self.model.device)
        print("the device2 = ", self.device)
